...
import { Group, Ellipse as KonvaEllipse, Rect, Text } from "react-konva";
...
const Ellipse = memo(function Ellipse({
	object,
	isSelected = false,
	onSelect,
	onMove,
	...
	const handleDragEnd = (e: any) => {
		...
		console.log(
			`🔵 Ellipse moved to: (${newPos.x.toFixed(1)}, ${newPos.y.toFixed(1)})`,
		);
