...
export default function Triangle({
  ...
  const handleDragEnd = (e: any) => {
    ...
    console.log("🔺 Triangle drag end:", {
      centerX,
      centerY,
      "object.width": object.width,
      "object.height": object.height,
      "width/2": object.width / 2,
      "height/2": object.height / 2,
      newX,
      newY,
      oldX: object.x,
      oldY: object.y,
  ...
  const handleTransformEnd = (e: any) => {
    ...
    console.log("🔄 Triangle transform end:", {
      centerX,
      centerY,
      radius,
      scaleX,
    ...
    console.log("🔄 Triangle transform updates:", {
      newX,
      newY,
      newWidth,
      newHeight,
  ...
  const getTriangleProps = () => {
    ...
    console.log("🔺 Triangle getTriangleProps:", {
      "object.x": x,
      "object.y": y,
      "object.width": width,
