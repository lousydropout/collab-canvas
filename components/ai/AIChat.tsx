      ...
      <div className="bg-white shadow-lg border border-gray-200 overflow-hidden">
        ...
        <div className="p-4 bg-gray-50">
          ...
          <div className="mt-2 space-y-2">
            <div>
              <p className="text-xs text-gray-500 mb-1">Create:</p>
              <div className="flex flex-wrap gap-1">
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => setInputValue("create a blue rectangle")}
                  className="h-6 px-2 text-xs hover:bg-gray-100 cursor-pointer"
                >
                  Blue Rectangle
                </Button>
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => setInputValue("add 3 circles")}
                  className="h-6 px-2 text-xs hover:bg-gray-100 cursor-pointer"
                >
                  3 Circles
                </Button>
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => setInputValue("2x2 grid of triangles")}
                  className="h-6 px-2 text-xs hover:bg-gray-100 cursor-pointer"
                >
                  2x2 Grid
                </Button>
            ...
            <div>
              <p className="text-xs text-gray-500 mb-1">Modify selected:</p>
              <div className="flex flex-wrap gap-1">
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => setInputValue("make 2x as large")}
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  onClick={() => setInputValue("move to bottom-left")}
                  disabled={selectedObjects.length === 0}
                  className={`h-6 px-2 text-xs ${
                    selectedObjects.length === 0
                      ? "opacity-50 cursor-not-allowed"
